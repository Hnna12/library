...
<?php
 $sql1 = mysqli_query($db, "SELECT student.pic, message.username FROM student INNER JOIN message ON student.username = message.username GROUP BY student.pic, message.username ORDER BY student.pic, message.username, MAX(message.status);");
  ...
  <div class="right_box2">
    ...
    if (isset($_POST['username']))
      if(isset($_POST['submit']))
      {
        ...
        mysqli_query($db, "UPDATE message SET status='yes' WHERE sender='student' AND username='$_POST[username]' AND message='$_POST[message]';");
